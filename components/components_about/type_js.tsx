...
const TypeJS: React.FC = () => {
  return (
    <>
      <div className="table-row">
        <span className="table-cell select-none text-gray-700 w-8 text-right pr-4">1</span>
        <span className="table-cell">
          <span className="text-gray-500">// Criando o objeto do meu perfil</span>
        </span>
      </div>
      <div className="table-row">
        <span className="table-cell select-none text-gray-700 w-8 text-right pr-4">2</span>
        <span className="table-cell">
          <span className="text-purple-400">const</span> <span className="text-blue-300">perfil</span> <span className="text-gray-400">=</span> <span className="text-yellow-400">{'{'}</span>
        </span>
      </div>
      <div className="table-row">
      ...
      <div className="table-row">
        ...
        <span className="table-cell pl-4">
          <span className="text-sky-300">hobbies</span><span className="text-gray-400">:</span> <span className="text-yellow-400">[</span><span className="text-orange-300">"Música"</span><span className="text-gray-400">,</span> <span className="text-orange-300">"Código"</span><span className="text-gray-400">,</span> <span className="text-orange-300">"Futebol"</span><span className="text-yellow-400">]</span>
        </span>
      </div>
      <div className="table-row">
